              ...
              <div className="row">
                <div className="col-md-12">
                  <form>
                    <MDBCard wide>
                      <MDBCardImage
                        className="view view-cascade gradient-card-header peach-gradient text-center"
                        cascade
                        tag="div"
                      >
                        <br />
                    ...
                    <MDBCard wide>
                      <MDBCardImage
                        className="view view-cascade gradient-card-header blue-gradient text-center"
                        cascade
                        tag="div"
                      >
                        <br />
                          ...
                          <div className="form-group col-md-3">
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="Immersion"
                                checked={
                                  this.state.baptizeNature === "Immersion"
                                }
                              />
                              <label className="form-check-label">
                                Immersion
